    ...
    <div <?php post_class('single-post-container') ?> id="post-<?php the_ID(); ?>">
      ...
      <div class="social-media-bar">
        ...
        <div class="social-link-container">
          <a target="_blank"  href="mailto:?subject=<?php the_title(); ?>&amp;body=Check out this site <?php the_permalink(); ?>" class="s-link s-email"></a>
          <a target="_blank"  href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>&ptitle=<?php the_title(); ?>" class="s-link s-facebook"></a>
          <a target="_blank"  href="http://twitter.com/share?text=<?php the_title(); ?>&url=<?php the_permalink(); ?>" class="s-link s-twitter"></a>
          <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&description=<?php the_title(); ?>" class="s-link s-pinterest"></a>
        </div>
